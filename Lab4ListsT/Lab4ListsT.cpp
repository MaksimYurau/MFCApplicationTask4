...
// Lab4ListsT.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLab4ListsTApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLab4ListsTApp

CLab4ListsTApp::CLab4ListsTApp()
{
...
// Единственный объект CLab4ListsTApp

CLab4ListsTApp theApp;


// Инициализация CLab4ListsTApp

BOOL CLab4ListsTApp::InitInstance()
{
